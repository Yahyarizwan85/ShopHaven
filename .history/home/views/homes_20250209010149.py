...
from .models import Product, CarouselImg, Category  # Import Category model

def index(request):
    """Displays all products, categories, and carousel images on the homepage."""
    products = Product.get_all_Product()
    carousel_items = CarouselImg.objects.all()  # Fetch all carousel items
