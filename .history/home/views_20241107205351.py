...
def login(request):
    if request.method == 'GET':
        ...
        if user_customer:
            flag = check_password(password, user_customer.password)
            print("Password check:", flag)  # Debug: check if password check passes
        ...
        print("User:", user_customer)  # Debugging: Ensure user is found
        return render(request, 'login.html')